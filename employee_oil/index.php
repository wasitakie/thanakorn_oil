...
<body>
    ...
    <div class="container" style="margin-top:2rem;">
        <div class="col-md-12">
            ...
            <p style="text-align:center"><strong><span style="font-size:18px">บริษัท ธนากรผลิตภัณฑ์น้ำมันพืช</span></strong><br /> <br><span style="font-size: 25px;"><img src="../img/undraw_Diary_re_4jpc.png" width="200px"></br>พนักงาน Outsource / สังกัด</span>
                &nbsp;</p>
            <hr>
